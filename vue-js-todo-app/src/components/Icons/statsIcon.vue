...
const props = defineProps(["fillColor", "width"]);

const iconFillColor = computed(() => {
	return `fill-${props.fillColor}`;
});

const iconHoverFillColor = computed(() => {
	return `fill-${props.hoverFillColor}`;
});
